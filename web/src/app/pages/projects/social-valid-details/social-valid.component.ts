...
export class SocialValidDetailsComponent implements AfterViewInit {
    pages_showcase_gallery = [
        {
            name: "Passport",
            src: `${environment.assetHost}/projects/social_valid/passport_view.mp4`,
            thumb: `${environment.assetHost}/projects/social_valid/passport_view_thumb.png`,
        ...
        {
            name: "Portfolio",
            src: `${environment.assetHost}/projects/social_valid/portfolio_full.mp4`,
            thumb: `${environment.assetHost}/projects/social_valid/portfolio_full_thumb.png`,
        ...
        {
            name: "Bio",
            src: `${environment.assetHost}/projects/social_valid/bio_customize.mp4`,
            thumb: `${environment.assetHost}/projects/social_valid/bio_customize_thumb.png`,
    ...
    themes_showcase_gallery = [
        {
            ...
            src: `${environment.assetHost}/projects/social_valid/portfolio_templates.mp4`,
            thumb: `${environment.assetHost}/projects/social_valid/portfolio_templates_thumb.png`,
        ...
        },
        {
            ...
            src: `${environment.assetHost}/projects/social_valid/alternate_portfolios.mp4`,
            thumb: `${environment.assetHost}/projects/social_valid/alternate_portfolios_thumb.png`,
        ...
        },
        {
            ...
            src: `${environment.assetHost}/projects/social_valid/light_dark.mp4`,
            thumb: `${environment.assetHost}/projects/social_valid/light_dark_thumb.png`,
    ...
    agencies_showcase_gallery = [
        {
            ...
            src: `${environment.assetHost}/projects/social_valid/agency_featured.mp4`,
            thumb: `${environment.assetHost}/projects/social_valid/agency_featured_thumb.png`,
        ...
        },
        {
            ...
            src: `${environment.assetHost}/projects/social_valid/roster_list.mp4`,
            thumb: `${environment.assetHost}/projects/social_valid/roster_list_thumb.png`,
            description: "Agency users can view the app as any of their managed users in order to create or update pages for that user."
        },
    ];
    homepageDemoSrc = `${environment.assetHost}/projects/social_valid/website.mp4`
    ambassadorDemoSrc = `${environment.assetHost}/projects/social_valid/ambassador_reports.mp4`
    backOfficeDemoSrc = `${environment.assetHost}/projects/social_valid/back_office.mp4`
